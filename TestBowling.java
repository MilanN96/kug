...
public class TestBowling {
	...
	public void testScoreWhenLastFrameIsSpare() throws BowlingException {
		bg = new BowlingGame();
		// Helper to add 9 frames with same score
	...
	// Helper to add certain amount of frames to BowlingGame object, with random
	// scores between 0-5
	...
	// Helper to add certain amount of frames to BowlingGame object with exact
	// score sent as argument
